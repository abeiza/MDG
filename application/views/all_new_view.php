...
<script>
	$(function(){
		$(function(){
			$.ajax({
				url:"<?php echo base_url();?>index.php/request/get_list_all_new/",
				cache:false,
				type: "POST",
				dataType: 'json',
		...
		$(function(){
			$.ajax({
				url:"<?php echo base_url();?>index.php/request/get_list_new_vendor/",
				cache:false,
				type: "POST",
				dataType: 'json',
				success:function(result){
		...
		$(function(){
			$.ajax({
				url:"<?php echo base_url();?>index.php/request/get_list_new_customer/",
				cache:false,
				type: "POST",
				dataType: 'json',
				success:function(result){
	...
	<div class="container">
		<div class="bg-list">
			...
			<div class="middle-box">
				...
				<div style="float: right;margin-right: 65px;"><h3>New Update List</h3></div>
