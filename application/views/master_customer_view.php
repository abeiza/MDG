...
<script>
  ...
  function linkDisplayInbox(id){
    $(function(){
			var iden = '';
      $.ajax({
        url:"<?php echo base_url();?>index.php/request/get_data_detail_customer_draft/"+id.id,
        cache:false,
        type: "POST",
        dataType: 'json',
        success:function(result){
		...
		<div class="bg-list">
			...
			<div class="middle-box">
				...
				<div class="group-btn">
					...
					<button id="excel-btn" onclick="downloadExcel();"></button>
			...
			<div class="list-box">
  			<div id="tab-table" style="float:left;width:100%;margin-top: 20px;">
  				<a class="tab" id="list-tab">List Customer</a>
