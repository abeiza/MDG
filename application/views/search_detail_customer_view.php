...
<script>
	$(function(){
      ...
      $.ajax({
		...
		$(function(){
			$.ajax({
				url:"<?php echo base_url();?>index.php/request/get_list_ms_customer/",
				cache:false,
				type: "POST",
				dataType: 'json',
				success:function(result){
            ...
            if(data.MDG_Status == 2){
              ...
              status = '';
						...
						//$("#tbl-all tbody").append("<tr><td>Request ID (Vendor)</td><td>Vendor Name</td><td>Vendor Type</td><td>Posted Date</td><td>Created By</td></tr>");
						$("#tbl-list tbody").append("<tr class='tr-customer' style='font-size:12px' id='"+data.MDG_Customer_ID+"' onclick='linkDisplayInbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td>"+data.MDG_CustomerType_ID+" - "+data.CustomerType_Name+"</td><td>"+title+" "+data.MDG_CustomerName+"</td><td>"+data.CustomerCity_Name+"</td><td>"+data.MDG_Country+"</td><td>"+status+"</td></tr>");
					});
				}
			});
		});
				...
				success:function(result){
					...
					$.each(result, function(i, data1){
						...
						$.ajax({
							...
							success:function(result){
								$.each(result, function(i, data){
									if(data1.Mapping_approval_person == data){
										$(".drop ul #"+data+" span").append("<img src='<?php echo base_url();?>assets/img/check.png' style='width:10px;'/>");
											$(".drop ul #"+data).css("background-color","#3C78DD");
											$(".drop ul #"+data).css("color","#fff");
											$(".drop ul #"+data).css("border","1px solid #3C78DD");
									}
								});
								$('#loadingDivNews').hide();
							}
	...
	<div class="container">
		<div class="bg-list">
			...
			<div class="list-box">
  			...
  			<div id="tbl-form" style="width:100%;float:left">
          ...
          <div class="list-box" style="width:30%;float:left;background-color:#fff;">
            ...
            <ul class="list-log">
              <li></li>
				...
				<div id="tbl-line" style="width:100%;float:left;">
