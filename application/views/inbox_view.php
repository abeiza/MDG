...
<script>
	...
	function linkDisplayInbox(id){
			var elem = $(id).attr("class");
			var id_inbox = $(id).attr("id");
			window.location.href = '<?php echo base_url()?>'+elem+'/'+id_inbox;
	}
...
<script>
	$(function(){
		$(function(){
			$.ajax({
				url:"<?php echo base_url();?>index.php/request/get_list_inbox/",
				cache:false,
				type: "POST",
				dataType: 'json',
				success:function(result){
					...
					$.each(result, function(i, data){
						//$("#tbl-all tbody").append("<tr><td>Request ID (Vendor)</td><td>Vendor Name</td><td>Vendor Type</td><td>Posted Date</td><td>Created By</td></tr>");
						var subject = '';
						if(data.InboxMDG_Subject == null){
							subject = '';
						}else{
							subject = data.InboxMDG_Subject;
						}

						if(data.InboxType == 'Request'){
							if(data.InboxMDG_Status == 0){
									$("#tbl-all tbody").append("<tr class='"+data.InboxMDG_Link+"/"+data.InboxType+"/"+data.InboxMDG_To_Account+"' id='"+data.InboxMDG_ID+"' style='font-size:12px' onclick='linkDisplayInbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td> From : "+data.Account_First_Name+" "+data.Account_Last_Name+"</td><td>"+subject.substring(1,25)+"... | <span style='color:#999'>"+data.InboxMDG_ShortText+"...</span></td><td>"+data.InboxMDG_Arrived+"</td></tr>");
							}else{
									$("#tbl-all tbody").append("<tr class='"+data.InboxMDG_Link+"/"+data.InboxType+"/"+data.InboxMDG_To_Account+"' id='"+data.InboxMDG_ID+"' style='font-size:12px' onclick='linkDisplayInbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td style='font-family:Roboto-light'> From : "+data.Account_First_Name+" "+data.Account_Last_Name+"</td><td style='font-family:Roboto-light'>"+subject.substring(1,25)+"... | <span style='color:#999'>"+data.InboxMDG_ShortText+"...</span></td><td style='font-family:Roboto-light'>"+data.InboxMDG_Arrived+"</td></tr>");
							}
						}else if(data.InboxType == 'Approval'){
							if(data.InboxMDG_Status == 0){
									$("#tbl-all tbody").append("<tr class='"+data.InboxMDG_Link+"/"+data.InboxType+"/"+data.LOG_ID+"' id='"+data.InboxMDG_ID+"' style='font-size:12px' onclick='linkDisplayInbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td> From : "+data.Account_First_Name+" "+data.Account_Last_Name+"</td><td>"+subject.substring(1,25)+"... | <span style='color:#999'>"+data.InboxMDG_ShortText+"...</span></td><td>"+data.InboxMDG_Arrived+"</td></tr>");
							}else{
									$("#tbl-all tbody").append("<tr class='"+data.InboxMDG_Link+"/"+data.InboxType+"/"+data.LOG_ID+"' id='"+data.InboxMDG_ID+"' style='font-size:12px' onclick='linkDisplayInbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td style='font-family:Roboto-light'> From : "+data.Account_First_Name+" "+data.Account_Last_Name+"</td><td style='font-family:Roboto-light'>"+subject.substring(1,25)+"... | <span style='color:#999'>"+data.InboxMDG_ShortText+"...</span></td><td style='font-family:Roboto-light'>"+data.InboxMDG_Arrived+"</td></tr>");
							}
						}
		...
		$(function(){
			$.ajax({
				url:"<?php echo base_url();?>index.php/request/get_list_inbox_vendor/",
				cache:false,
				type: "POST",
				dataType: 'json',
				success:function(result){
					...
					$.each(result, function(i, data){
						...
						if(data.InboxType == 'Request'){
							if(data.InboxMDG_Status == 0){
									$("#tbl-vendor tbody").append("<tr class='"+data.InboxMDG_Link+"/"+data.InboxType+"/"+data.InboxMDG_To_Account+"' id='"+data.InboxMDG_ID+"' style='font-size:12px' onclick='linkDisplayInbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td> From : "+data.Account_First_Name+" "+data.Account_Last_Name+"</td><td>"+subject.substring(1,25)+"... | <span style='color:#999'>"+data.InboxMDG_ShortText+"...</span></td><td>"+data.InboxMDG_Arrived+"</td></tr>");
							}else{
									$("#tbl-vendor tbody").append("<tr class='"+data.InboxMDG_Link+"/"+data.InboxType+"/"+data.InboxMDG_To_Account+"' id='"+data.InboxMDG_ID+"' style='font-size:12px' onclick='linkDisplayInbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td style='font-family:Roboto-light'> From : "+data.Account_First_Name+" "+data.Account_Last_Name+"</td><td style='font-family:Roboto-light'>"+subject.substring(1,25)+"... | <span style='color:#999'>"+data.InboxMDG_ShortText+"...</span></td><td style='font-family:Roboto-light'>"+data.InboxMDG_Arrived+"</td></tr>");
							}
						}else if(data.InboxType == 'Approval'){
		...
		$(function(){
			$.ajax({
				url:"<?php echo base_url();?>index.php/request/get_list_inbox_customer/",
				cache:false,
				type: "POST",
				dataType: 'json',
				success:function(result){
					...
					$.each(result, function(i, data){
						...
						if(data.InboxType == 'Request'){
							if(data.InboxMDG_Status == 0){
									$("#tbl-customer tbody").append("<tr class='"+data.InboxMDG_Link+"/"+data.InboxType+"/"+data.InboxMDG_To_Account+"' id='"+data.InboxMDG_ID+"' style='font-size:12px' onclick='linkDisplayInbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td> From : "+data.Account_First_Name+" "+data.Account_Last_Name+"</td><td>"+subject.substring(1,25)+"... | <span style='color:#999'>"+data.InboxMDG_ShortText+"...</span></td><td>"+data.InboxMDG_Arrived+"</td></tr>");
							}else{
									$("#tbl-customer tbody").append("<tr class='"+data.InboxMDG_Link+"/"+data.InboxType+"/"+data.InboxMDG_To_Account+"' id='"+data.InboxMDG_ID+"' style='font-size:12px' onclick='linkDisplayInbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td style='font-family:Roboto-light'> From : "+data.Account_First_Name+" "+data.Account_Last_Name+"</td><td style='font-family:Roboto-light'>"+subject.substring(1,25)+"... | <span style='color:#999'>"+data.InboxMDG_ShortText+"...</span></td><td style='font-family:Roboto-light'>"+data.InboxMDG_Arrived+"</td></tr>");
							}
						}else if(data.InboxType == 'Approval'){
...
<script>
  ...
  function getLinked(menu){
	...
	function btnSearchDetail(src){
		var search = $("#search-txt").val();
		//var replaced = search.split(' ').join('-');
		window.location.href = '<?php echo base_url()?>index.php/request/get_search/'+encodeURI(search);
	}
</script>
<body>
	<div class="container">
		<div class="bg-list">
			...
			<div class="middle-box">
				...
				<div style="float: right;margin-right: 65px;"><h3>Inbox List</h3></div>
