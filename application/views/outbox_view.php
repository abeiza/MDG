...
<script>
	...
	function linkDisplayOutbox(id){
			var elem = $(id).attr("class");
			var id_outbox = $(id).attr("id");
			window.location.href = '<?php echo base_url()?>'+elem+'/'+id_outbox;
	}
...
<script>
	$(function(){
		$(function(){
			$.ajax({
				url:"<?php echo base_url();?>index.php/request/get_list_Outbox/",
				cache:false,
				type: "POST",
				dataType: 'json',
				success:function(result){
					...
					$.each(result, function(i, data){
						var subject = '';
						if(data.OutboxMDG_Subject == null){
							subject = '';
						}else{
							subject = data.OutboxMDG_Subject;
						}

						if(data.OutboxType == 'Request'){
							if(data.OutboxMDG_Status == 0){
									$("#tbl-all tbody").append("<tr class='"+data.OutboxMDG_Link+"/"+data.OutboxType+"/"+data.OutboxMDG_To_Account+"' id='"+data.OutboxMDG_ID+"' style='font-size:12px' onclick='linkDisplayOutbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td> To : "+data.Account_First_Name+" "+data.Account_Last_Name+"</td><td>"+subject.substring(1,25)+"... | <span style='color:#999'>"+data.OutboxMDG_ShortText+"...</span></td><td>"+data.OutboxMDG_Send+"</td></tr>");
							}else{
									$("#tbl-all tbody").append("<tr class='"+data.OutboxMDG_Link+"/"+data.OutboxType+"/"+data.OutboxMDG_To_Account+"' id='"+data.OutboxMDG_ID+"' style='font-size:12px' onclick='linkDisplayOutbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td style='font-family:Roboto-light'> To : "+data.Account_First_Name+" "+data.Account_Last_Name+"</td><td style='font-family:Roboto-light'>"+subject.substring(1,25)+"... | <span style='color:#999'>"+data.OutboxMDG_ShortText+"...</span></td><td style='font-family:Roboto-light'>"+data.OutboxMDG_Send+"</td></tr>");
							}
						}else if(data.OutboxType == 'Approval'){
								if(data.OutboxMDG_Status == 0){
										$("#tbl-all tbody").append("<tr class='"+data.OutboxMDG_Link+"/"+data.OutboxType+"/"+data.LOG_ID+"' id='"+data.OutboxMDG_ID+"' style='font-size:12px' onclick='linkDisplayOutbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td> To : "+data.Account_First_Name+" "+data.Account_Last_Name+"</td><td>"+subject.substring(1,25)+"... | <span style='color:#999'>"+data.OutboxMDG_ShortText+"...</span></td><td>"+data.OutboxMDG_Send+"</td></tr>");
								}else{
										$("#tbl-all tbody").append("<tr class='"+data.OutboxMDG_Link+"/"+data.OutboxType+"/"+data.LOG_ID+"' id='"+data.OutboxMDG_ID+"' style='font-size:12px' onclick='linkDisplayOutbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td style='font-family:Roboto-light'> To : "+data.Account_First_Name+" "+data.Account_Last_Name+"</td><td style='font-family:Roboto-light'>"+subject.substring(1,25)+"... | <span style='color:#999'>"+data.OutboxMDG_ShortText+"...</span></td><td style='font-family:Roboto-light'>"+data.OutboxMDG_Send+"</td></tr>");
								}
						}
		...
		$(function(){
			$.ajax({
				url:"<?php echo base_url();?>index.php/request/get_list_outbox_vendor/",
				cache:false,
				type: "POST",
				dataType: 'json',
				success:function(result){
					...
					$.each(result, function(i, data){
						...
						if(data.OutboxType == 'Request'){
							if(data.OutboxMDG_Status == 0){
									$("#tbl-vendor tbody").append("<tr class='"+data.OutboxMDG_Link+"/"+data.OutboxType+"/"+data.OutboxMDG_To_Account+"' id='"+data.OutboxMDG_ID+"' style='font-size:12px' onclick='linkDisplayOutbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td> To : "+data.Account_First_Name+" "+data.Account_Last_Name+"</td><td>"+subject.substring(1,25)+"... | <span style='color:#999'>"+data.OutboxMDG_ShortText+"...</span></td><td>"+data.OutboxMDG_Send+"</td></tr>");
							}else{
									$("#tbl-vendor tbody").append("<tr class='"+data.OutboxMDG_Link+"/"+data.OutboxType+"/"+data.OutboxMDG_To_Account+"' id='"+data.OutboxMDG_ID+"' style='font-size:12px' onclick='linkDisplayOutbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td style='font-family:Roboto-light'> To : "+data.Account_First_Name+" "+data.Account_Last_Name+"</td><td style='font-family:Roboto-light'>"+subject.substring(1,25)+"... | <span style='color:#999'>"+data.OutboxMDG_ShortText+"...</span></td><td style='font-family:Roboto-light'>"+data.OutboxMDG_Send+"</td></tr>");
							}
						}else if(data.OutboxType == 'Approval'){
								if(data.OutboxMDG_Status == 0){
										$("#tbl-vendor tbody").append("<tr class='"+data.OutboxMDG_Link+"/"+data.OutboxType+"/"+data.LOG_ID+"' id='"+data.OutboxMDG_ID+"' style='font-size:12px' onclick='linkDisplayOutbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td> To : "+data.Account_First_Name+" "+data.Account_Last_Name+"</td><td>"+subject.substring(1,25)+"... | <span style='color:#999'>"+data.OutboxMDG_ShortText+"...</span></td><td>"+data.OutboxMDG_Send+"</td></tr>");
								}else{
										$("#tbl-vendor tbody").append("<tr class='"+data.OutboxMDG_Link+"/"+data.OutboxType+"/"+data.LOG_ID+"' id='"+data.OutboxMDG_ID+"' style='font-size:12px' onclick='linkDisplayOutbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td style='font-family:Roboto-light'> To : "+data.Account_First_Name+" "+data.Account_Last_Name+"</td><td style='font-family:Roboto-light'>"+subject.substring(1,25)+"... | <span style='color:#999'>"+data.OutboxMDG_ShortText+"...</span></td><td style='font-family:Roboto-light'>"+data.OutboxMDG_Send+"</td></tr>");
								}
						}
		...
		$(function(){
			$.ajax({
				url:"<?php echo base_url();?>index.php/request/get_list_outbox_customer/",
				cache:false,
				type: "POST",
				dataType: 'json',
				success:function(result){
					...
					$.each(result, function(i, data){
						...
						if(data.OutboxType == 'Request'){
							if(data.OutboxMDG_Status == 0){
									$("#tbl-customer tbody").append("<tr class='"+data.OutboxMDG_Link+"/"+data.OutboxType+"/"+data.OutboxMDG_To_Account+"' id='"+data.OutboxMDG_ID+"' style='font-size:12px' onclick='linkDisplayOutbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td> To : "+data.Account_First_Name+" "+data.Account_Last_Name+"</td><td>"+subject.substring(1,25)+"... | <span style='color:#999'>"+data.OutboxMDG_ShortText+"...</span></td><td>"+data.OutboxMDG_Send+"</td></tr>");
							}else{
									$("#tbl-customer tbody").append("<tr class='"+data.OutboxMDG_Link+"/"+data.OutboxType+"/"+data.OutboxMDG_To_Account+"' id='"+data.OutboxMDG_ID+"' style='font-size:12px' onclick='linkDisplayOutbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td style='font-family:Roboto-light'> To : "+data.Account_First_Name+" "+data.Account_Last_Name+"</td><td style='font-family:Roboto-light'>"+subject.substring(1,25)+"... | <span style='color:#999'>"+data.OutboxMDG_ShortText+"...</span></td><td style='font-family:Roboto-light'>"+data.OutboxMDG_Send+"</td></tr>");
							}
						}else if(data.OutboxType == 'Approval'){
								if(data.OutboxMDG_Status == 0){
										$("#tbl-customer tbody").append("<tr class='"+data.OutboxMDG_Link+"/"+data.OutboxType+"/"+data.LOG_ID+"' id='"+data.OutboxMDG_ID+"' style='font-size:12px' onclick='linkDisplayOutbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td> To : "+data.Account_First_Name+" "+data.Account_Last_Name+"</td><td>"+subject.substring(1,25)+"... | <span style='color:#999'>"+data.OutboxMDG_ShortText+"...</span></td><td>"+data.OutboxMDG_Send+"</td></tr>");
								}else{
										$("#tbl-customer tbody").append("<tr class='"+data.OutboxMDG_Link+"/"+data.OutboxType+"/"+data.LOG_ID+"' id='"+data.OutboxMDG_ID+"' style='font-size:12px' onclick='linkDisplayOutbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td style='font-family:Roboto-light'> To : "+data.Account_First_Name+" "+data.Account_Last_Name+"</td><td style='font-family:Roboto-light'>"+subject.substring(1,25)+"... | <span style='color:#999'>"+data.OutboxMDG_ShortText+"...</span></td><td style='font-family:Roboto-light'>"+data.OutboxMDG_Send+"</td></tr>");
								}
						}
	...
	<div class="container">
		<div class="bg-list">
			...
			<div class="middle-box">
				...
				<div style="float: right;margin-right: 65px;"><h3>Outbox List</h3></div>
