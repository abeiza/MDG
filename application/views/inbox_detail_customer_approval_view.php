...
<script>
	$(function(){
		if('<?php echo $this->uri->segment(2);?>' == 'new'){
			$.ajax({
				url:"<?php echo base_url();?>index.php/request/get_data_detail_draft_customer_log/<?php echo $this->uri->segment(4);?>/<?php echo $this->uri->segment(8);?>",
				cache:false,
				type: "POST",
				dataType: 'json',
			...
			$.ajax({
				url:"<?php echo base_url();?>index.php/request/get_data_detail_customer_approval/<?php echo $this->uri->segment(4);?>/<?php echo $this->uri->segment(8);?>/<?php echo $this->uri->segment(7);?>/<?php echo $this->uri->segment(2);?>",
				cache:false,
				type: "POST",
				dataType: 'json',
				success:function(result){
			...
			$.ajax({
				url:"<?php echo base_url();?>index.php/request/get_data_detail_draft_customer_log/<?php echo $this->uri->segment(4);?>/<?php echo $this->uri->segment(6);?>",
				cache:false,
				type: "POST",
				dataType: 'json',
				success:function(result){
			...
			$.ajax({
				url:"<?php echo base_url();?>index.php/request/get_data_detail_customer_approval/<?php echo $this->uri->segment(4);?>/<?php echo $this->uri->segment(6);?>/<?php echo $this->uri->segment(7);?>/<?php echo $this->uri->segment(2);?>",
				cache:false,
				type: "POST",
				dataType: 'json',
				success:function(result){
		...
		<div class="bg-list">
			...
			<div class="middle-box">
				...
				<div class="group-btn">
					...
					<div id="title-mail" style="margin-left:20px;float:left;"><h3><?php echo "Approval Data Customer";?></h3></div>
