...
<script>
	$(function(){
		$(function(){
			$.ajax({
				url:"<?php echo base_url();?>index.php/control/get_list_confirm_all/",
				cache:false,
				type: "POST",
				dataType: 'json',
            ...
            $("#tbl-all tbody").append("<tr class='tr-"+data.Code+"' style='font-size:12px' id='"+data.MDG_ID+"' onclick='linkDisplayInbox(this)' style='Font-size:13px;font-family:Roboto-Regular'><td>"+data.Code+"</td><td>"+data.type_id+" - "+data.typename+"</td><td>"+data.name+"</td><td>"+data.address+"</td><td>"+data.name_province+"</td><td>"+data.first+" "+data.last+"</td><td>"+stts+"</td></tr>");
					});
				}
			}
    );
		...
		<div class="bg-list">
			...
			<div class="middle-box">
				...
				<div class="group-btn">
					...
					<button id="excel-btn" onclick="listDetail();"></button>
				</div>
