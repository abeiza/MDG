...
<script>
  ...
  function get_send(){
    ...
    $load_id.show();
    $.ajax({
      url:"<?php echo base_url();?>index.php/control/get_confirm_app_vendor/",
      cache:false,
      data:{
  ...
  <div class="container">
    <div class="bg-list">
      ...
      <div class="middle-box">
        ...
        <div style="float: right;margin-right: 65px;"><h3>Confirm : Master Data Vendor</h3></div>
      ...
      <div class="list-box">
        <div class="form-create">
          <h3 style="margin-top:10px;width:100%;float:left;">
            <div style="float:left;">Display Master Data Vendor</div>
